...
#' likely) generated by [write_translations()]. It contains source and unparsed
#' translations and relevant metadata. It can be viewed as a portable and
#' human-readable serialization of a [`Translator`][Translator] object. It
...
#' [read_translations()]. It is parsed back into a [`Translator`][Translator]
#' object.
#'
...
#' [`Translator`][Translator] objects. See below for details.
#'
...
#' ```
#'
#' Spaces before and after titles (`#` and `##`) are ignored.
#'
#' ## Rules
#'
