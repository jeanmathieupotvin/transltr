...
#' likely) generated by [translator_export()]. It contains source translations
...
#' [translator_import()]. The latter converts it to a [`Translator`][Translator]
#' object.
#'
