...
#'
#' * [isTranslateCall()] returns `TRUE` if `call` is a [call][base::call] to
#'   [translate()] and `FALSE` othwerwise.
#'
#' @note
...
#' thanks to the *original author* and to `R Core Team`.
#'
#' @examples
...
#' @rdname get-translations-from-expresssion
#' @keywords internal
getStringFromTranslateCall <- function(call, env = new.env()) {
